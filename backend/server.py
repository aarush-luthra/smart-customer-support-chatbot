...
def run_server(host: str = "localhost", port: int = 8000):
    ...
    print("   Demonstrating Data Structures in Action")
    print("=" * 60)
    print()
    print(f"   Server running at: http://{host}:{port}")
    print()
    print("   Data Structures Used:")
    print("   • Trie (Prefix Tree) - Auto-suggestions")
    print("   • Queue (deque) - Query management")
    print("   • Priority Queue (heapq) - Urgent queries")
    print("   • HashMap (dict) - FAQ responses")
    print("   • Tree - Conversation flow")
    print("   • Deque (bounded) - Recent context cache")
    print()
